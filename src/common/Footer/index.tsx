...
const FooterComponent: React.FunctionComponent = () => {
  return (
      <footer className='static z-30 w-full bg-black/80 text-white'>
        <div className="container flex flex-col sm:mt-8 sm:mx-4 sm:px-8">
          <div className='block sm:flex flex-row justify-start my-4 sm:my-8 pr-4 sm:pr-0 sm:py-8'>
            <div className='flex flex-col px-16 text-md my-4 sm:my-0 sm:text-xl font-["Merriweather"] sm:border-r-2 border-gray-50'>
              <span className='pb-4 sm:pb-8 text-xl sm:text-2xl'>Infomation</span>
            ...
            <div className='flex flex-col px-16 text-md my-4 sm:my-0 sm:text-xl font-["Merriweather"]'>
              <span className='pb-4 sm:pb-8 text-xl sm:text-2xl'>Category</span>
              <a href='#' className='group'>
            ...
            <div className='ml-auto flex items-center justify-center shadow-lg bg-gradient-to-tr from-indigo-300 to-violet-700 rounded-md'>
              <div className='flex items-center flex-col sm:flex-row font-["Merriweather"]'>
                <span className='text-center text-md sm:text-3xl sm:mx-16 mt-4 sm:mt-0 text-black'>Let's start Watchlist to watch more the best movies!</span>
